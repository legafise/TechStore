                ...
                <div class="col-xl-4">
                    <div class="card text-center registration-form-idents">
                        ...
                        <div class="card-body authorization">
                            <form action="${updateGoodCommand}" method="post" class="reg-inputs"
                                  enctype="multipart/form-data">
                                <div class="row row-in-registration">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            <label for="name">Название</label>
                                            <input type="text" value="${good.name}" class="form-control" id="name" name="name">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" min="1" max="100000" placeholder="0,00"
                                                   class="form-control" value="${good.price}" id="price" name="price">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description"
                                              ...
                                              placeholder="Описание" maxlength="400">${good.description}</textarea>
                                </div>
                                <div class="row row-in-registration">
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="type" name="type" >
                                                <c:forEach var="type" items="${goodTypes}">
                                                    <option ${type == good.type ? 'selected' : ''} value="${type}">${type}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
