...
public class UpdateGoodCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request) throws CommandException {
        try {
            if (!validateGoodData(request)) {
                request.getSession().setAttribute("updatingResult", false);
    ...
    private boolean validateGoodData(HttpServletRequest request) {
        ...
        return name != null && price != null && type != null && description != null && !name.isEmpty()
                && !price.isEmpty() && !type.isEmpty() && !description.isEmpty();
    }
}
